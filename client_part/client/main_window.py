...
from client_part.client.main_window_conv import UiMainClientWindow
from client_part.client.add_contact import AddContactDialog
from client_part.client.del_contact import DelContactDialog
from client_part.common.variables import SENDER, TEXT
