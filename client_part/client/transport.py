...
from client_part.common.utils import get_message, send_message
from client_part.common.variables import RESPONSE, TEXT, ACTION, ERROR, GET_CONTACTS, TIME, USER, SENDER, RECIPIENT, \
